...
- Run Lighthouse CI with `pnpm dlx @lhci/cli autorun` after building the frontend.
- Run `cd frontend && pnpm test:e2e` for the browser workflows and populated desktop admin screenshot.
